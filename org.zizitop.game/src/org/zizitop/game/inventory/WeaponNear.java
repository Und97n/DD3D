...
//
//	protected void attack(InventoryOwner hero, World w) {
//		needAttack = false;
//
//		double ax = hero.getPosX() + hero.getDirectionX() * 0.5;
//		double ay = hero.getPosY() + hero.getDirectionY() * 0.5;
//
...
//
//	@Override
//	public void onKeyReleased(InventoryOwner hero, World w) {
//		nextSwing = false;
//

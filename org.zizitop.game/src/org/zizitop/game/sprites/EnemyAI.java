...
//		}
//
//		if(target instanceof BreakableStructure && ((BreakableStructure)target).isDead()) {
//			targets.pop();
//
//			return;
//		}
//
//		if(w.isSpriteVisible(actor, target) && !(target instanceof Sprite && (!((Sprite)target).isVisible()))) {
//			targetVisible = true;
//			hasTarget = true;
//
...
//						(((TargetPoint)target).deleteIfSeeEnemy && w.isSpriteVisible(actor, hr) && hr.isVisible())) {
//					targets.pop();
//				}
//			}
//		}
...
//		Point p = new TargetPoint(x, y, 0, false, 60);
//		targets.push(p);
//	}
//
